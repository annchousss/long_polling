...
@Component
public class TokenAuthenticationProvider implements AuthenticationProvider { // after FILTER
    // класс описывающий работу аутентификации
    ...
    @Override // authentication пришел из фильтра (метод setAuteniication)
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        // делаем явное преобразование для работы с TokenAuthentication
        TokenAuthentication tokenAuthentication = (TokenAuthentication) authentication; // кастим обратно ))0)
